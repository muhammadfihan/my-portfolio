            ...
            <div className="lg:pr-8 lg:pt-4">
              <div className="lg:max-w-xl">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  ...
                  degree to enhance my skills and abilities. Currently, I am expanding my knowledge
                  in machine learning and data science as part of my ongoing S1 education. With the
                  knowledge and experiences I have gained, I am particularly interested in pursuing
                  a career in junior web development or machine learning engineering.
                </p>
